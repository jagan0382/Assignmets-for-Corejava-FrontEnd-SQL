...
14. Converting to uppercase and lowercasem
*/
...
/* O/P ->   This is a string
			Creating a string object and placed in memory "Heap"
			This String is Concatenated
			String Length : 13
			Extracted string : tracting
			At Index : 10
			At Index : 5
			Matches : true
			Equal : true
			...
			Ends with : true
			Compared : 0
			Trimmed : Trimming String
			Replaced : Replacinn strinn
			Splitted : Splitting
			Splitted : String
			Converted Num to Str : 1122
			Converted int to str : 1133
			Converted to upper case : UPPER CASE
			Converted yo lower case : lower case
*/