...
public class Insert_At_SpecificPosition {
...
/* O/P -> 		original Array : my_arr = [11, 22, 33, 44, 55, 66, 77, 88, 99]
				Enter the index number : 2
				Enter the value to insert at index my_arr[2] =  00
				Array after Inserting Element : 
				my_arr = [11, 22, 0, 44, 55, 66, 77, 88, 99]
  */
