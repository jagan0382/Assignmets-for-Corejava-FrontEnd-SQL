/*
 * 01. Write two methods with the same name but different number of parameters of same type and call the methods from main method
 * 02. Write two methods with the same name but different number of parameters of different data type and call the methods from main method
 * 03. Write two methods with the same name and same number of parameters of same type and call from main method
 * 04. Write two methods with the same name and same number of parameters of different type and call from main method
 * 05. Write two methods with the same name, number of parameters and data type but different return Type
 */
...
/* O/P->        1.First number : 11
				1.Sum of two numbers : 30
				2.Roll number : 317
				2.Roll number : 317 ; Name : Sharan
				4.Roll number : 317
				4.Name : Sharan
 */
