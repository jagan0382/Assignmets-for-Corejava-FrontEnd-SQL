...
/* O/P ->   After adding elements to HashSet :
			jala = [zero, nine, six, four, one, seven, ten, two, three, five, eight]
			
			Iterating through the HashSet : 
			zero nine six four one seven ten two three five eight  
			
			clone/copy of HashSet : 
			[zero, nine, six, four, one, seven, ten, two, three, five, eight]
			
			After removing element 'zero' :
			jala = [nine, six, four, one, seven, ten, two, three, five, eight]
