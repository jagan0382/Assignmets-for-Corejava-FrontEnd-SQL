...
/* O/P -> 
			jala = [zero, one, two, three, four, five]
			
			After adding elements :
			jala = [zero, one, two, three, four, five, six, seven, eight, nine]
			
			Iterating through the ArrayList : 
			zero one two three four five six seven eight nine  
			
			After adding an element at index 1 :
			jala = [zero, AtIndex1, one, two, three, four, five, six, seven, eight, nine]
